...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full h-[60px] md:h-[80px] flex justify-between items-center px-2 sm:px-4 md:px-6 ${isDark ? 'bg-[#0a192f]' : 'bg-white border-b border-gray-100'} ${isDark ? 'text-gray-300' : 'text-gray-700'} z-50`}>
      <div>
        <img src={Logo} alt='Portfolio Logo' style={{ width: '120px', mdWidth: '150px' , marginTop:'8px' }} />
      </div>
      ...
      <div className='flex items-center gap-4'>
        <button
          onClick={toggleTheme}
          className={`p-2 rounded-full ${isDark ? 'bg-yellow-400 text-gray-900' : 'bg-gray-800 text-yellow-400'} transition-colors duration-300`}
